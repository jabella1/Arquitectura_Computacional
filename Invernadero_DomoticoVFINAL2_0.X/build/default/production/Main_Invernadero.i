...
void main(){
    ...
    while(1){
     if(PrimeraVez==1){
        ...
        ControlHumedadAspersorVentilador(&Datos[1],HumedadAdecuada,MargenEH);


        ControlTemperaturaCalefactorVentilador(&Datos[0],TemperaturaAdecuada,MargenET);
# 53 "Main_Invernadero.c"
