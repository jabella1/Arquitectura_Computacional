...
// unsigned char keyfind(). Retorna la tecla que se presione en el teclado como un char sin signo.
...
//Recibe como parametro un vector de tipo unsigned char el cual ya estará lleno
//Lo que hace es convertir los datos que tiene ese vector de char a entero y despues retornarlo.
...
//conecta el puerto b a 5vcc a traves de una resistencia interna
