...
_Bool VentiladoresEncendidosTemp=0;
_Bool VentiladoresEncendidosHum=0;
...
void ControlHumedadAspersorVentilador(char *HumedadActual,int HumedadDigitada,int MargenErrorH){
    if(*HumedadActual<HumedadDigitada-MargenErrorH){
        ...
        if(VentiladoresEncendidosTemp!=1){
            PrenderVentiladores();
            VentiladoresEncendidosHum=1;
        }
    }else{
        ApagarAspersores();
        if(VentiladoresEncendidosTemp!=1){
            ApagarVentiladores();
            VentiladoresEncendidosHum=0;
        }
    }
}
# 114 "Actuadores.c"
void ControlTemperaturaCalefactorVentilador(char *TempActual,int TempDigitada,int MargenErrorT){
    if(*TempActual>TempDigitada+MargenErrorT){
        if(VentiladoresEncendidosHum!=1){
        PrenderVentiladores();
        VentiladoresEncendidosTemp=1;
        }
